  ...
  <script src="<?php echo base_url(); ?>assets/dashboard/js/hoverable-collapse.js"></script>
  <script src="<?php echo base_url(); ?>assets/dashboard/js/template.js"></script>
  <!-- endinject -->
  <!-- Custom js for this page-->
  <script src="<?php echo base_url(); ?>assets/dashboard/js/dashboard.js"></script>
  <script src="<?php echo base_url(); ?>assets/dashboard/js/data-table.js"></script>
  <script src="<?php echo base_url(); ?>assets/dashboard/js/jquery.dataTables.js"></script>
  <script src="<?php echo base_url(); ?>assets/dashboard/js/dataTables.bootstrap4.js"></script>
